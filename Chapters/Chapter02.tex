...
%\hline
% \textbf{Dataset} & \textbf{Total Images} & \multicolumn{3}{c|}{\textbf{Images Per Category}}\\
%& & Min & Max & Mean \\
%\hline
%\hline
...
%\begin{figure}
%\begin{center}
%\includegraphics[width=\linewidth]{./gfx/Chapter02/methods-v5.pdf}
...
%\begin{table}[h]
%\begin{center}
%  \begin{tabular}{|c|C{1.15cm}|C{1.15cm}|C{1.15cm}|C{1.15cm}|}
%   \hline
...
%\begin{figure}[h]
%       \centering
%		\includegraphics[width=\linewidth]{./gfx/Chapter02/precision-recall.pdf}
...
%\begin{table}
%\begin{center}
%    \begin{tabular}{|c|>{\centering\arraybackslash}m{1.1cm}|>{\centering\arraybackslash}m{1.1cm}|>{\centering\arraybackslash}m{1.1cm}|>{\centering\arraybackslash}m{1.1cm}|}
%    \hline
