...
\subsection{Dataset}
\label{sec:Dataset}
For this experiments we use the sequences from the RSM dataset which acquisition and details were described in \ref{ch:chapter4}. The dataset is publicly available for download at \url{http://rsm.bicv.org} \citep{Rivera-RubioRSM}.
