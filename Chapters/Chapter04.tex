...
\begin{table}
\caption{Cumulative distribution function values against localisation error in metres ($\epsilon$). $P(|\epsilon| < x)$, expressed as a percentage. From this table, SF-GABOR achieves a probability of 90\% of localising with an error below $2$ m, whilst LSD-SLAM achieves just above 50\% accuracy level for that error boundary, and using larger images and only for the best-case corridors and passes.}
\label{tbl:cdftable}
\centering
...
>>>>>>> cf882a3dbb167a39a637c416c6d43086cb5af90c
