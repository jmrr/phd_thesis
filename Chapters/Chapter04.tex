...
\label{sec:Dataset}
In order to allow different approaches to be compared, and as a community resource to develop this technique, the datasets are made publicly available {\em Authors' note: to avoid violating ECCV anonymization rules for this ACVR Workshop, the data will be made available only if/when the final version of the paper is accepted.}
