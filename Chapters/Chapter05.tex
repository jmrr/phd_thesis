...
One way to mimic the behaviour of BPCs within APCs becomes patent when we revisit the {\it kernel} function we introduced in the previous chapter. This {\it kernel} maps a pair of FEVs onto a positive scalar value. We used the following mapping between two vectors $\mathbf{v}_a$ and $\mathbf{v}_b$:
\be
